...
<head>
    ...
    <link rel="stylesheet" href="/plugins/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="demo/user_setting" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-iframe-tab="demo/user_password" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                    </dd>
                    <dd>
...
<script src="/plugins/layui-v2.5.4/layui.js?v=1.0.4" charset="utf-8"></script>
